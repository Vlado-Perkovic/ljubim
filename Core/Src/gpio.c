...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4|LED_GREEN_Pin|GPIO_PIN_6, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CMP1_Pin CMP2_Pin */
  GPIO_InitStruct.Pin = CMP1_Pin|CMP2_Pin;
  ...
  /*Configure GPIO pin : CMP3_Pin */
  GPIO_InitStruct.Pin = CMP3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CMP3_GPIO_Port, &GPIO_InitStruct);
